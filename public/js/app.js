...
var form = document.querySelector(".prevent-multiple-submit-form");
console.log(form);
var btnSubmit = document.querySelector(".prevent-multiple-submit-button"); // using null safty opertaor
